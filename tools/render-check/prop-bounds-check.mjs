...
// M9-E 함정 소품 추가(2026-08-23): living.notepad + study.pencilCase 2개 추가.
// 35 + 2 = 37.
...
console.log(`OK   소품/하위노드 총 개수 ${results.length}개 정확히 일치(furniture.js 최상위 32개 + 시계 하위 2개 + 기계장치 하위 2개 + 상자더미 순증 1개)`);
